...
namespace Ecommerce.API.Migrations
{
    ...
    public partial class RecreateProductsTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("IF OBJECT_ID('Products', 'U') IS NOT NULL DROP TABLE Products");
            migrationBuilder.Sql("IF OBJECT_ID('ProductReviews', 'U') IS NOT NULL DROP TABLE ProductReviews");
