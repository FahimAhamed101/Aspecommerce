...
namespace Ecommerce.API.Migrations
{
    ...
    [Migration("20260206012015_AddOrders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Core.Entities.CustomerWishList", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Ecommerce.Core.Entities.WishListItem", b =>
                {
                    ...
                    b.Property<string>("CustomerWishListId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Ecommerce.Core.Entities.WishListItem", b =>
                {
                    b.HasOne("Ecommerce.Core.Entities.CustomerWishList", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Ecommerce.Core.Entities.orderAggregate.Order", b =>
                {
                    ...
                    b.OwnsOne("Ecommerce.Core.Entities.orderAggregate.OrderAddress", "AddressToShip", b1 =>
                        {
            ...
            modelBuilder.Entity("Ecommerce.Core.Entities.orderAggregate.OrderItem", b =>
                {
                    b.HasOne("Ecommerce.Core.Entities.orderAggregate.Order", "Order")
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("Ecommerce.Core.Entities.orderAggregate.ProductItemOrdered", "ProductItemOrdered", b1 =>
                        {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Ecommerce.Core.Entities.Identity.ApplicationUser", null)
                        .WithMany()
